            ...
            <form className='contact__form'>
                <div className='contact__input-set'>
                    <div className='contact__form-first-column'>
                        <Input max={100} placeholder={localization.form.inputs.first}/>
                        <div
                        ...
                        >
                            ...
                            />
                            <Input max={75} choosedMethod={choosedMethod}/>
                        </div>
                        <Dropdown
                    ...
                    <div className='contact__form-second-column'>
                        <Textarea dropFilesLabel={localization.form.textarea.filedrop} max={2000} placeholder={localization.form.textarea.placeholder}/>
                    </div>
                </div>
                <div className='contact__submit'>
                    <Button value={localization.form.button}/>
                    <SocialMedias/>
                </div>
            </form>
